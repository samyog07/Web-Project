...
?>
    ...
    <div class="main-container main-top-padding">

        <section class="page-title page-title-3 image-bg overlay parallax">
            <div class="background-image-holder">
                <img alt="Background Image" class="background-image" src="img/blog-head.jpeg"/>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center" style="margin-bottom:22px;">
                        <h3 class="uppercase mb0">News and Events</h3>
                    </div>
                    <div class="text-center col-sm12">
            ...
            <div class="container">
                ...
                <div class="row masonry masonryFlyIn mb40">
                    <div class="col-sm-4 post-snippet masonry-item">
                        <a href="#">
                            <img alt="Post Image" src="img/gallery-head.jpeg"/>
                        </a>
                        <div class="inner">
                            <a href="#" class="custom-a-color">
                            ...
                            <a class="btn btn-sm custom-transparent-blue" href="#">Read More</a>
                            <ul class="tags pull-right">
                                <li>
                                    <a class="btn btn-sm btn-icon custom-transparent-blue" href="#">
                    ...
                    <div class="col-sm-4 post-snippet masonry-item">
                        <iframe class="mb0"
                                src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/167666836&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
                        <div class="inner">
                            <a href="#" class="custom-a-color">
                    ...
                    <div class="col-sm-4 post-snippet masonry-item">
                        <a href="#">
                            <img alt="Post Image" src="img/in-gallery-head.jpeg"/>
                        </a>
                        <div class="inner">
                            <a href="#" class="custom-a-color">
                    ...
                    <div class="col-sm-4 post-snippet masonry-item">
                        <div class="embed-video-container embed-responsive embed-responsive-16by9 mb0">
                            <iframe class="embed-responsive-item mb0"
                                    src="http://player.vimeo.com/video/25737856?badge=0&title=0&byline=0&title=0"
